label scene5:
    ...
    r "Belum, nih. Coba aku lihat."

    "Aku membuka grup MABA PENS di ponselku, dan tidak ada kabar kalau akan ada pembagian kelompok."

    r "Kayaknya belum ada pengumuman deh,"

    d "Lho, tapi tadi aku lihat ada yang ngomongin soal pembagian kelompok. Apa mungkin aku salah lihat ya?"

    r "Mungkin aja,"

    r "Atau mungkin pengumumannya di grup lain."

    "Kami berdua kembali fokus pada ponsel masing-masing, mencari informasi tentang pembagian kelompok. Namun, setelah beberapa menit, kami tidak menemukan apa-apa."

    r "Mungkin nanti diumumkan pas acara dimulai,"

    d "Iya, mungkin juga. Semoga aja kita satu kelompok ya, Den,"
    ...
    "Aku mulai bermimpi untuk bisa mendapatkan salah satu beasiswa tersebut suatu hari nanti."

    "Yang paling mengejutkan, PKKMB Technogear tidak sekeras yang kubayangkan sebelumnya. Tidak ada bentakan atau perlakuan kasar dari kakak tingkat. Mereka justru sangat ramah dan membantu."

    "Kami diajarkan tentang pentingnya kerjasama, saling menghargai, dan menjunjung tinggi nilai-nilai kebangsaan."
