label scene12:
    ...
    play music sekar_bgm fadein 1.0 volume 0.5
    ...
    "Aku dan teman-teman segera berdiskusi dan membagi kelompok kami. Aku bergabung dengan tim pro."
